...
{
    public partial class FamilyMemberDetailModel : BaseNopEntityModel
    {
        public FamilyMemberDetailModel()
        {
            DefaultPictureModel = new PictureModel();
            PictureModels = new List<PictureModel>();
            Breadcrumb = new FamilyMemberBreadcrumbModel();
            RelatedMembers = new List<FamilyMemberOverviewModel>();
            FamilyMemberInfoNavigationModel = new FamilyMemberInfoNavigationModel();
        }
        ...
        public FamilyMemberInfoNavigationModel FamilyMemberInfoNavigationModel { get; set; }
